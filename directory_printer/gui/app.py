...
class DirectoryPrinterApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Directory Printer v0.1.0")
    ...
    def setup_ui(self):
        ...
        author_link = self.create_link_label(author_frame, "ysskrishna", 
        ...
        github_link = self.create_link_label(author_frame, "GitHub", 
                                           "https://github.com/ysskrishna/directory-printer")
